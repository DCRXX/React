...
const couresAPI = {
    getMenu: async ()=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])('/coures/menu');
    }
};
}),
...
function MenuContent({ isMobile, currentRouteId, onCourseClick }) {
    ...
    ;
    const handlecourseClick = undefined;
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1c00d95d._.js.map