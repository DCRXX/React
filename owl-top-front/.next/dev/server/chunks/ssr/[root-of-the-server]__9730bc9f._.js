...
async function initializeRoutes() {
    ...
    initializationPromise = (async ()=>{
        try {
            const response = await fetch('/menu/routes'); // или ваш URL
            if (!response.ok) {
...
function RouteInitializer({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$React$2f$top$2d$app$2f$owl$2d$top$2d$front$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Вызываем инициализацию только на клиенте
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$React$2f$top$2d$app$2f$owl$2d$top$2d$front$2f$app$2f$src$2f$components$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeRoutes"])().then(()=>setIsReady(true)).catch((error)=>{
            console.error('Failed to initialize routes:', error);
            setIsReady(true); // Показываем UI даже при ошибке
        });
    }, []);
    // Можно показать loader пока инициализируется
    if (!isReady) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$React$2f$top$2d$app$2f$owl$2d$top$2d$front$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            children: "Загрузка приложения..."
        }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9730bc9f._.js.map