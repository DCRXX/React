...
function RootLayout(t0) {
    ...
    if ($[0] !== "59df3f247b267a4e3297b3309fd7d71d2019001413be4ed662dd17b57711cd92") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "59df3f247b267a4e3297b3309fd7d71d2019001413be4ed662dd17b57711cd92";
    }
    const { children } = t0;
    let t1;
    let t2;
...
//# sourceMappingURL=Desktop_React_top-app_owl-top-front_app_82f1ff50._.js.map