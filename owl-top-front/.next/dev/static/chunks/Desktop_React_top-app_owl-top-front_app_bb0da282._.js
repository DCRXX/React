...
async function initializeRoutes() {
    ...
    initializationPromise = (async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$React$2f$top$2d$app$2f$owl$2d$top$2d$front$2f$app$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["menuAPI"].getRoutes();
            if (!response.ok) {
...
function RouteInitializer(t0) {
    ...
    if ($[0] !== "70aaec993e16be7a7b926a50cc6a3d8fa69906b08c0722a6622f7140459f048f") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "70aaec993e16be7a7b926a50cc6a3d8fa69906b08c0722a6622f7140459f048f";
    }
    const { children } = t0;
...
//# sourceMappingURL=Desktop_React_top-app_owl-top-front_app_bb0da282._.js.map