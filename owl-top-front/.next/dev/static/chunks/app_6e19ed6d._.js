...
function MenuContent({ isMobile, currentRouteId, onCourseClick }) {
    ...
    /*Хуки для данных акардеона*/ const designCourses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$src$2f$components$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRoutesBySubcategory"])('courses', 'design');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MenuContent.useEffect": ()=>{
            const loadMenu = {
                "MenuContent.useEffect.loadMenu": async ()=>{
                    try {
                        setLoading(true);
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$routes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["couresAPI"].getMenu();
                        setCategories(data);
                        setError(null);
                    } catch (err) {
            ...
            }["MenuContent.useEffect.loadMenu"];
            loadMenu();
        }
    }["MenuContent.useEffect"], []);
...
_s(MenuContent, "LMypNi9mwsxjky+lxmCP8J+Kn24=", false, function() {
    return [
...
//# sourceMappingURL=app_6e19ed6d._.js.map